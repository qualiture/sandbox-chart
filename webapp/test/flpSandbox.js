		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Charting with D3",
									"targetURL": "#nlqualiturespcsandboxsandboxchart-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nlqualiturespcsandboxsandboxchart-display": {
								"semanticObject": "nlqualiturespcsandboxsandboxchart",
								"action": "display",
								"description": "Charting with D3 (sandbox)",
								"title": "Charting with D3",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=nl.qualiture.spc.sandbox.sandboxchart",
									"url": sap.ui.require.toUrl("nl/qualiture/spc/sandbox/sandboxchart")
								}
							}
						}
					}
